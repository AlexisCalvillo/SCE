...
DROP TABLE affablebean.ordered_product;
DROP TABLE affablebean.customer_order;
DROP TABLE affablebean.product;
DROP TABLE affablebean.category;
DROP TABLE affablebean.customer;
...
(
  ...
  customer_id INT  NOT NULL CONSTRAINT CUST_ORD_FK REFERENCES affablebean.customer
);
------------------------------- 
--     CATEGORY
-------------------------------
...
INSERT INTO affablebean.category (name) VALUES 
('dairy'),
('meats'),
('bakery'),
('fruit & veg');
...
INSERT INTO affablebean.product (name,price,description,last_update,category_id) VALUES
