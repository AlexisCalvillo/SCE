...
public class TstEscBailePojo {
    ...
    public static void main(String[] args) {
        ...
        //===========================================================
        //===========================================================
        //=================Crea las condiciones para eliminar========
        cveAlumno=args.length==1?args[0]:"cveAl_";
        nomAlumno="nomAl_";
        ...
        t0=System.currentTimeMillis();
        //Prueba de funcionalidad 2.4
        //=================Elimina con cierto prefijo========
    ...
    private static boolean altaAlumno(java.lang.String cveAlumno, java.lang.String nombreAlumno, java.lang.String apPaternoAlumno,java.lang.String apMaternoAlumno,wsescbaile.NewWebService port) {
    ...
    private static boolean bajaLike(java.lang.String cveAlumno) {
        wsescbaile.Bajas_Service service = new wsescbaile.Bajas_Service();
        wsescbaile.Bajas port = service.getBajasPort();
