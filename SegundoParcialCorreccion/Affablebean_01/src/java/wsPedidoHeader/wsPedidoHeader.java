...
public class wsPedidoHeader {
    ...
    @WebMethod(operationName = "totAmount")
    public double totAmount() {
        //TODO write your implementation code here:
        return ejbRef.getTotAmount();
    }
    @WebMethod(operationName = "totAmountForCustOrd")
    public double totAmountForCustId(@WebParam(name = "custId") int id) {
        //TODO write your implementation code here:
        return ejbRef.getTotAmountForCustOrd(id);
    }
